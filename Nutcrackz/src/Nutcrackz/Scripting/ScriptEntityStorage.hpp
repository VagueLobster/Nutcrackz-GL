...
namespace Nutcrackz {
	...
	inline uint64_t DataTypeSize(DataType type)
	{
		...
		case DataType::Vector2: return sizeof(rtmcpp::Vec2);
		case DataType::Vector3: return sizeof(rtmcpp::Vec3);
		case DataType::Vector4: return sizeof(rtmcpp::Vec4);
	...
	public:
		...
		{
			NZ_CORE_VERIFY(m_Type->IsSZArray());
